...
public class PersonResource
{
   ...
   public Response getPersons( @Context UriInfo uriInfo )
   {
      ...
      {
         p.addLink( getUriForSelf( p, uriInfo ), "self" );
         p.addLink( getUriForInsurance( p, uriInfo ), "insurance" );
      }
   ...
   @GET
   @Path( "/{personId}" )
   public Response getPerson( @PathParam( "personId" ) long id, @Context UriInfo uriInfo )
   {
   ...
   public InsuranceResource getInsuranceResource()
   {
   ...
   {
      String uri = uriInfo.getBaseUriBuilder().path( PersonResource.class ).path( Long.toString( person.getId() ) ).build().toString();
      return uri;
   ...
   private String getUriForInsurance( Person person, UriInfo uriInfo )
   {
      ...
      String uri = uriInfo.getBaseUriBuilder().path( PersonResource.class ).path( PersonResource.class, "getInsuranceResource" ).path( InsuranceResource.class ).resolveTemplate( "personId", person.getId() ).build().toString();
      return uri;
   }
